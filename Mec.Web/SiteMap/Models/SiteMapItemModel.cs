...
//     </File>
//     <Summary>
//         SiteMapItemModel.cs is a part of Mec
//     </Summary>
// <License>
//--------------------------------------------------
#endregion License
...
namespace Mec.Web.SiteMap.Models
{
    ...
    /// </summary>
    public sealed class SiteMapItem : MecDisposableModel, ISiteMapItem
    {
        ...
        ///     result pages. Search engines may use this information when sMecing between URLs on
        ...
        ///     priority is relative, it is only used to sMec between URLs on your site.
        /// </summary>
