...
namespace Mec.Core.ConcurrentUtils
{
    /// <inheritdoc />
    /// <summary>
    ///     Override <see cref="M:Mec.Core.ConcurrentUtils.Models.MecMessageQueue`1.Execute(System.Collections.Generic.ICollection{`0})" /> to write your job
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class MecMessageQueue<T> : MecDisposableModel where T : class, new()
    {
        #region Fields
        ...
        protected MecMessageQueue(uint batchSize, TimeSpan threshold)
        {
            BatchSize = batchSize;
